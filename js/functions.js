...
function renderAboutMenu() {
  ...
  <h2>
    Skapare från
    <a class="yrgo" href="https://www.yrgo.se/" target="_blank">Yrgo</a>
  </h2>
  <button class="return">
...
<div class="pages">
  ...
  <div id="game-developers" class="page">
    ...
    <div class="text">
      <h2>Emilie Vogel och Jonatan</h2>
      <p>
  ...
  <div id="game-artists" class="page">
    ...
    <div class="text">
      ...
      <p>
        ...
        att föra fram den grafiska stämningen och visuella ton som passade vår
        vision. Jag har tagit fram olika koncept på hur vår berättelse hade
        förmedlats på bästa sätt visuellt och utifrån gruppens samtycke har jag
        färdigställt grafiken vi har i bidraget. Jag har designat och skapat
        karaktärerna samt bakgrunderna i vårt bidrag.
      </p>
    </div>
  </div>
